...
# Load forex data
forex = pd.read_csv('./output/processed_XAUUSD_30m.csv', parse_dates=['time'])
...
cpi = pd.read_excel('./data/xlsx/CPI.xlsx')
gdp = pd.read_excel('./data/xlsx/GDP.xlsx')
# Load the new macroeconomic data
interest_rate = pd.read_excel('./data/xlsx/Interest_Rate.xlsx')
nfp = pd.read_excel('./data/xlsx/NFP.xlsx')
pce = pd.read_excel('./data/xlsx/PCE.xlsx')
ppi = pd.read_excel('./data/xlsx/PPI.xlsx')
...
output_file = './output/forex_with_all_macros.xlsx'
forex_with_ppi.dropna(inplace=True)
forex_with_ppi.to_excel(output_file, index=False)

print(f'Merged data saved to {output_file}')
forex_with_ppi.to_excel('./output/processed2_all_macros.xlsx', index=False)
...
# human_df.to_excel('./output/Time_readable_time_all_macros.xlsx', index=False)
