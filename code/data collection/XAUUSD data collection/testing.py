...
print("First few UTC timestamps:")
print(all_data['time'].head())

# Check broker-local time (IC Markets = UTC+2 or UTC+3 depending on DST)
all_data['time_broker'] = all_data['time'].dt.tz_localize('UTC').dt.tz_convert('Europe/Athens')  # IC server time
print("First few broker-local times:")
print(all_data[['time', 'time_broker']].head())
